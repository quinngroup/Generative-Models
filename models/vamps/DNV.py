...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.dconv1= DeformConvPack(1,8,kernel_size=3)
        #(8,13,13) -> (16,12,12)
        self.conv2 = nn.Conv2d(8, 16, 2)
        self.dconv2= DeformConvPack(8,16,kernel_size=2)
        #(16,6,6) -> (32,4,4)
        self.conv3 = nn.Conv2d(16, 32, 3)
        self.dconv3= DeformConvPack(16,32,kernel_size=3)
        #(32,4,4) -> (64,2,2)
        self.conv4 = nn.Conv2d(32, 64, 3)
        self.dconv4=DeformConvPack(32,64,kernel_size=3)
