...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.dconv1= DeformConvPack(1,8,kernel_size=3, deformable_groups=1)
        #(8,13,13) -> (16,12,12)
        #self.conv2 = nn.Conv2d(8, 16, 2)
        self.dconv2= DeformConvPack(8,16,kernel_size=2,deformable_groups=1)
        #(16,6,6) -> (32,4,4)
        #self.conv3 = nn.Conv2d(16, 32, 3)
        self.dconv3= DeformConvPack(16,32,kernel_size=3,deformable_groups=1)
        #(32,4,4) -> (64,2,2)
        #self.conv4 = nn.Conv2d(32, 64, 3)
        self.dconv4=DeformConvPack(32,64,kernel_size=3,deformable_groups=1)
    ...
    def loss_function(self, recon_x, x, mu, logvar, z_q,pseudo,recon_pseudo,p_mu,p_logvar,p_z):
        ...
        #pseudo-loss
        pRE = F.mse_loss(recon_pseudo.view(-1,784), pseudo.view(-1, 784), reduction = 'sum')
        ...
        return (RE + args.beta*KL)+args.gamma*(pRE + args.beta*pKL)/args.batch_size
...
def train(epoch):
    ...
    for batch_idx, (data, _) in enumerate(train_loader):
        ...
        pseudos=model.means(model.idle_input).view(-1,1,28,28).to(device)
