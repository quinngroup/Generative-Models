...
#print(os.listdir())
#print(os.getcwd())
from utils.nn import true_spatial_broadcast_decoder
import math
import numpy as np
...
class VAE(nn.Module):
    def __init__(self, input_length, lsdim, pseudos, beta, gamma, batch_size, device):
        ...
        self.sbd=true_spatial_broadcast_decoder(input_length=self.input_length,device=self.device,lsdim=self.lsdim)
