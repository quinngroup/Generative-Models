...
#print(os.listdir())
from vamps.NatVampPriorCilia import NatVampPriorCilia
...
if args.batchNorm:
    ...
    model = NatVampPriorCilia(args.batch_size, args.input_length, args.lsdim, args.pseudos, args.beta, args.gamma, device, args.logvar_bound).to(device)
